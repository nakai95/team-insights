...
export interface DeploymentFrequencyBarChartProps {
...
/**
 * DeploymentFrequencyBarChart Component
 *
 ...
 * - Formatted axes
 */
export const DeploymentFrequencyBarChart = React.memo(
  function DeploymentFrequencyBarChart({
    data,
    aggregationLevel,
    height = 400,
  }: DeploymentFrequencyBarChartProps) {
